        ...
        $(document).ready(function(e)
        {
            ...
            dataTable = $('#tableId').DataTable({
                ...
                [
                    ...
                    { data    : "createduser[0].name", name: "createduser" },
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">  
                            <div class="pull-left form-inline">
                                {!! Form::text('txtSearch',null,['class' => 'form-control input-sm', 'id' => 'txtSearch', 'placeholder' => 'Kode / Nama Berat']) !!}
                                {!! Form::hidden('txtTipe',null,['id' => 'txtTipe', 'style' => 'width:200px;']) !!}
                            ...
                            <div class="pull-right">
                                <a href="{{route('berat.add')}}" class="btn btn-success btn-sm"><i class="fa fa-plus-square "></i> Tambah Berat</a>
                            </div>  
                            @endif
                        </div>
