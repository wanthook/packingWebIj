            ...
            <div class="row">
                <div class="col-lg-12"> 
                    <h4 class="page-header">
                        ...
                        </span>&nbsp;&nbsp;<a href="{{route('timbangan.list')}}">List Timbangan</a>&nbsp;>&nbsp;Form Timbangan
                    </h4>
                </div>     
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Form Timbangan Indah Jaya
                        </div>                        
                        @if(!isset($var->id))
                            {!! Form::model($var, ['url' => route('timbangan.save'),'class' => 'form-horizontal']) !!}
                        @else
                            {!! Form::model($var,['method' => 'PATCH', 'route' => ['timbangan.change',$var->id],'class' => 'form-horizontal']) !!}
                        @endif
                        <div class="panel-body">
                            ...
                            <div class="form-group{{ $errors->has('warna_cones')?' has-error':'' }}">
                                ...
                                <div class="col-xs-8">
                                    {!! Form::text('warna_cones',null,['class' => 'form-control', 'id' => 'warna_cones', 'placeholder' => 'Warna Cones']) !!}
                        ...
                        <div class="panel-footer">
                            ...
                            {!! Form::close() !!}
                            <a href="{{route('timbangan.list')}}" class="btn btn-danger"><i class="fa fa-arrow-left"></i>Kembali</a>
                        </div>
