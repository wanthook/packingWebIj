    ...
    <script>
        ...
        $(document).ready(function(e)
        {
            ...
            dataTable = $('#tableId').DataTable({
                ...
                "ajax":
                {
                    "url"       : "{{ route('timbangan.tabelDownload') }}",
                    "type"      : 'POST',
                    data: function (d) 
                    {
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            List Download Timbangan                           
                        </div>
                        
                        <div class="panel-body">  
                            <div class="pull-left form-inline">
                                {!! Form::text('txtSearch',null,['class' => 'form-control input-sm', 'id' => 'txtSearch', 'placeholder' => 'Kode / Nama Timbangan']) !!}
                            ...
                            <div class="pull-right">
                                <a href="{{route('timbangan.download')}}" class="btn btn-success btn-sm"><i class="fa fa-download "></i> Download Data Baru</a>
                            </div>  
                            @endif
                        </div>
